...
if($row_cnt>0)
{
echo"<script>alert('House alreadt exist');</script>";
}
else
{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Add a House</h2>
	
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Add a House</div>
...
<?php } ?>
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Select House </label>
												<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Rent(per house)</label>
<div class="col-sm-8">
...
<input class="btn btn-primary" type="submit" name="submit" value="Add House ">
												</div>
											</div>

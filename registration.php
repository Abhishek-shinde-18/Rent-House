...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			...
			<form action="javascript:sendmail()" method="post" action="" name="registration" class="form-horizontal">
...
<input  onclick="javascript:sendmail()"    type="submit" name="submit" Value="Register" class="btn btn-primary">
</div>
</form>
...
<script>
    function sendmail(){
     ...
     var name=$('fname').val();
     var body=fname+' , '+'you have successfully registered for house rental management';
    }
    Email.send({
    Host : "smtp.gmail.com",
    Username : "shindeabhishek1818@gmail.com",
    Password : "Anuraj@18",
    To : 'abhishekshinde1933@gmail.com',
    From : "shindeabhishek1818@gmail.com",

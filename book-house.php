...
$uid=$_SESSION['login'];
				...
				if($rs)
				{ ?>
			<h3 style="color: red" align="center">House already booked by you</h3>
			<div align="center">
			...
			<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												...
												<div class="stat-panel-number h1 ">My House</div>
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">House Related info </h4> </label>
</div>
...
<div class="form-group">
<label class="col-sm-2 control-label">Rent Per Month</label>
<div class="col-sm-8">
...
<div class="form-group">
<label class="col-sm-2 control-label">Nominee Contact no : </label>
<div class="col-sm-8">

		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:3%">House Details</h2>
...
<tr>
<td colspan="6" style="text-align:center; color:blue"><h3>House Realted Info</h3></td>
</tr>
<tr>
